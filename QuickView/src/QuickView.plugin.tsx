...
const UserProfileModalHeader_module
    = BdApi.findModule(m => m.default?.displayName === 'UserProfileModalHeader');

const UserBanner_module
    = BdApi.findModule(m => m.default?.displayName === 'UserBanner');

const NavItem_module
    = BdApi.findModule(m => m.default?.displayName === 'NavItem');

const ConnectedAnimatedEmoji_module
    = BdApi.findModule(m => m.default?.displayName === 'ConnectedAnimatedEmoji');

const GuildBanner_module
    = BdApi.findModuleByProps('AnimatedBanner');

const UserPopoutAvatar_module
    = BdApi.findModuleByProps('UserPopoutAvatar');

const AnimatedAvatar_module
    = BdApi.findModuleByProps('AnimatedAvatar');

const MessageHeader_module
    = BdApi.findModule(m => m.default?.displayName === 'MessageHeader');

const Embed_module
    = BdApi.findModuleByDisplayName('Embed');
